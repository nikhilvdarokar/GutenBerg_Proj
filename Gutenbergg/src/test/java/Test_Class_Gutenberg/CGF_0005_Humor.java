...
public class CGF_0005_Humor extends Gutenberg_Base_Class {
	...
	@Test
	public void CGF_0005Humor() throws IOException, Throwable {
		ghomepom.clickHumor_Button();
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);		
		String actualPageTitleFiction= "Humor";
		String expectedPageTitleFiction=Gutenberg_Utility.getTestData(2, 0);
